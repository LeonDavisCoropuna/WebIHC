...
export default function MainButton({ children, primary, style, icon }) {
  return (
    <button
      className={`${
        primary
      ...
      } flex items-center justify-center gap-2 p-5 text-lg uppercase font-body font-bold md:px-[34px] md:py-5 lg:w-full ${style}`}
    >
